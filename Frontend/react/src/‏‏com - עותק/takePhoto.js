...
function TakePhoto({ image, setImage, setType, type, setFlag, flag }) {
  ...
  return (
    <div>
      {!flag && <Button variant="contained" onClick={handleClick}>צלם מוצר</Button>}
      {image && !flag && <ImagePreview dataUri={image} isFullscreen={isFullscreen} setImage={setImage} setFlag={setFlag} flag={flag}/>}
      ...
      {/* {flag && <FaceRecognition setImage1={setImage} image1={image} type={type} setFlag={setFlag}/>} */}
